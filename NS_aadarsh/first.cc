...
main(int argc, char* argv[])
{
    ...
    Ptr<ConstantPositionMobilityModel> s0 =
    ...
    Ptr<ConstantPositionMobilityModel> s10 =
        nodes.Get(10)->GetObject<ConstantPositionMobilityModel>();
    Ptr<ConstantPositionMobilityModel> s11 =
        nodes.Get(11)->GetObject<ConstantPositionMobilityModel>();
    Ptr<ConstantPositionMobilityModel> s12 =
        nodes.Get(12)->GetObject<ConstantPositionMobilityModel>();
