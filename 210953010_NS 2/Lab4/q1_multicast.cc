...
main(int argc, char* argv[])
{
    ...
    NetDeviceContainer nd0 = pointToPoint.Install(c0); // First LAN
    ...
    ipv4Addr.SetBase("10.1.1.0", "255.255.255.0"); // classless
    ipv4Addr.Assign(nd0);
    ...
    s3->SetPosition(Vector(90, 90, 30));
    s4->SetPosition(Vector(150, 90, 40));
    s5->SetPosition(Vector(210, 90, 50));
