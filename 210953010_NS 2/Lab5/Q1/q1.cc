...
int main(int argc, char *argv[])
{
    ...
    bool tracing = true;
    uint32_t maxBytes = 0;
    std::string datarate="10Mbps",delay="5ms";
    ...
    BulkSendHelper source("ns3::TcpSocketFactory",
                          InetSocketAddress(i.GetAddress(4), port));
    ...
    if (tracing)
    {
        ...
        csma.EnableAsciiAll(ascii.CreateFileStream("tcp-bulk-send_"+delay+"_"+datarate+".tr"));
    ...
    s1->SetPosition(Vector(10, 30, 0));
    s2->SetPosition(Vector(10, 60., 0));
    s3->SetPosition(Vector(45, 45, 0));
    s4->SetPosition(Vector(50, 30, 0));
    s5->SetPosition(Vector(50, 60, 0));
